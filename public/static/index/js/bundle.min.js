!function(e, t) {
        ...
        e.prototype._updateData = function() {
            ...
            if (!(0 < this._requestsPending)) {
                ...
                var e = function(t) {
                  ...
                  , s = this;
                for (var t in this._subscribers)
                    e(t)
            }
        }
        ,
            ...
            if (!(0 < this._requestsPending)) {
                var e = function(t) {
                    ...
                    i._quotesProvider.getQuotes(1 === s ? r.fastSymbols : r.symbols).then(function(e) {
                        o._requestsPending--,
                        o._subscribers.hasOwnProperty(t) && (r.listener(e),
                        n("QuotesPulseProvider: data for #" + t + " (" + s + ") updated successfully, pending=" + o._requestsPending))
                    }).catch(function(e) {
                        o._requestsPending--,
    ...
    var t = function() {
        ...
        e.prototype.searchSymbols = function(a, u, c, o) {
            ...
            return this._readyPromise.then(function() {
                ...
                for (var e = function(e) {
                    ...
                    if (void 0 === t)
                        return "continue";
                    if (0 < c.length && t.type !== c)
                        return "continue";
                    if (u && 0 < u.length && t.exchange !== u)
                        return "continue";
        ...
        e.prototype._init = function() {
            for (var e = this, t = [], r = {}, s = 0, o = this._exchangesList; s < o.length; s++) {
                var i = o[s];
                r[i] || (r[i] = !0,
                t.push(this._requestExchangeData(i)))
            }
    ...
    var o = function() {
        ...
        e.prototype.searchSymbols = function(t, e, r, s) {
            if (this._configuration.supports_search) {
                ...
                this._send("search", o).then(function(e) {
                    if (void 0 !== e.s)
                        return n("UdfCompatibleDatafeed: search symbols error=" + e.errmsg),
                        void s([]);
                    s(e)
                }).catch(function(e) {
        ...
        e.prototype._requestConfiguration = function() {
            ...
            /*return this._send("config").catch(function(e){return n("UdfCompatibleDatafeed: Cannot get datafeed configuration - use default, error="+c(e)),null})*/
        }
        ,
        ...
        e.prototype._setupWithConfiguration = function(e) {
            if (void 0 === (this._configuration = e).exchanges && (e.exchanges = []),
            !e.supports_search && !e.supports_group_request)
                throw new Error("Unsupported datafeed configuration. Must either support search, or support group request");
            !e.supports_group_request && e.supports_search || (this._symbolsStorage = new t(this._datafeedURL,e.supported_resolutions || [],this._requester)),
