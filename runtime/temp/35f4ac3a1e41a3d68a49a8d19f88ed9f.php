<?php /*a:1:{s:63:"/home/wwwroot/study/application/admin/view/user/agent_list.html";i:1562835437;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            ...
            <a href="<?php echo url('admin/Api/excel_agent_list',input('get.')); ?>"  class="layui-btn" style="background-color: #337AB7">导出</a>
        </form>
    </div>
    <xblock>
