<?php /*a:1:{s:61:"/home/wwwroot/study/application/agent/view/log/agent_log.html";i:1562901408;}*/ ?>
<!DOCTYPE html>
<html>
      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          ...
          <input class="layui-input" placeholder="截止日" name="end" id="end" value="<?php echo input('get.end'); ?>">
            ...
            <!--<input type="text" name="operation_type"  placeholder="类型" autocomplete="off" class="layui-input" value="<?php echo input('get.operation_type'); ?>">-->
        ...
        <div class="layui-row">
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(1); ?>&end=<?php echo quick_time_select(2); ?>" class="layui-btn layui-btn-sm layui-btn-normal">昨天</a>
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(2); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">今天</a>
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(3); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本周</a>
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(4); ?>&end=<?php echo quick_time_select(5); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上周</a>
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(6); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本月</a>
            <a href="<?php echo url('agent/Log/log',input('get.')); ?>&start=<?php echo quick_time_select(7); ?>&end=<?php echo quick_time_select(8); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上月</a>
        </div>
      <xblock>
      ...
      <table class="layui-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="td-manage">
                    <button class="layui-btn layui-btn-sm " onclick="x_admin_show('查看','/agent/Log/log_info?id=<?php echo htmlentities($val['id']); ?>')">查看</button>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
