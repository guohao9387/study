<?php /*a:1:{s:62:"/home/wwwroot/study/application/admin/view/coin/coin_list.html";i:1562751629;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    ...
    <!--</div>-->
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加申购币','/admin/Coin/coin_add')"><i class="layui-icon"></i>添加</button>
    </xblock>
    <table class="layui-table">
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td class="td-manage">
                    <a title="编辑"  onclick="x_admin_show('编辑','/admin/Coin/coin_edit?id=<?php echo htmlentities($vo['id']); ?>')" href="javascript:;">
...
<script>
    ...
    function member_stop(obj,id){
        layer.confirm('确认要'+$(obj).attr('title')+'吗？',function(index){
            ...
            $.ajax({
                ...
                data:{id:id,status:status,db:'apply_coin',field:'show_status'},
                type:'post',
                dataType:'json',
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                url:'/admin/Api/status_change',
                data:{id:id,status:2,db:'apply_coin'},
                type:'post',
                dataType:'json',
                success:function(res){
                    if(res['status']==1){
