<?php /*a:1:{s:73:"/home/wwwroot/study/application/admin/view/money/agent_withdraw_list.html";i:1562751629;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            ...
            <a href="<?php echo url('admin/Api/excel_agent_withdraw_list',input('get.')); ?>"  class="layui-btn" style="background-color: #337AB7">导出</a>

        </form>
    </div>
    <div class="layui-row">
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(1); ?>&end=<?php echo quick_time_select(2); ?>" class="layui-btn layui-btn-sm layui-btn-normal">昨天</a>
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(2); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">今天</a>
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(3); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本周</a>
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(4); ?>&end=<?php echo quick_time_select(5); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上周</a>
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(6); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本月</a>
        <a href="<?php echo url('admin/Money/agent_withdraw_list',input('get.')); ?>&start=<?php echo quick_time_select(7); ?>&end=<?php echo quick_time_select(8); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上月</a>
    </div>
    <xblock>
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td class="td-manage">
                <?php if($vo['status'] == 1): ?>
                <button class="layui-btn layui-btn-xs" onclick="withdraw(2,<?php echo htmlentities($vo['id']); ?>)">通过</button>
                <button class="layui-btn layui-btn-xs layui-btn-warm" onclick="withdraw(3,<?php echo htmlentities($vo['id']); ?>)">拒绝</button>
                <?php endif; ?>
            </td>
        </tr>
        ...
        layer.confirm('确认要进行此操作吗？',function(index){
            ...
            if(status==3){
                ...
                layer.prompt({
                    ...
                    var load = layer.load();
                    $.ajax({
                        url:'/admin/Api/agent_withdraw_handle',
