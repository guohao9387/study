<?php /*a:1:{s:62:"/home/wwwroot/study/application/agent/view/user/user_list.html";i:1562901408;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <table class="layui-table">
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td class="td-status">
                    <a onclick="x_admin_show('会员邀请码','/agent/User/user_code?id=<?php echo htmlentities($vo['uid']); ?>')" href="javascript:;"  title="会员邀请码">
                        <span class="layui-btn layui-btn-mini " style="background-color: #C57979">查看</span>
                    </a>
                </td>
                <!--<td class="td-status">-->
                    <!--<a onclick="x_admin_show('银行卡信息','/agent/User/bank_list?username=<?php echo htmlentities($vo['username']); ?>&utype=1')" href="javascript:;"  title="银行卡信息">-->
                ...
                <td class="td-manage">
                    <div class="layui-btn-group">
                        ...
                        <button class="layui-btn layui-btn-sm" onclick="x_admin_show('查看详情','/agent/User/user_edit?uid=<?php echo htmlentities($vo['uid']); ?>')">查看详情</button>
