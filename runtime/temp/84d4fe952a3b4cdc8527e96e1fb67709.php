<?php /*a:1:{s:69:"/home/wwwroot/study/application/agent/view/order/keep_order_list.html";i:1562901408;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        ...
        <!--<div class="layui-row">-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(1); ?>&end=<?php echo quick_time_select(2); ?>" class="layui-btn layui-btn-sm layui-btn-normal">昨天</a>-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(2); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">今天</a>-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(3); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本周</a>-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(4); ?>&end=<?php echo quick_time_select(5); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上周</a>-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(6); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本月</a>-->
            <!--<a href="<?php echo url('agent/Order/order_list',input('get.')); ?>&start=<?php echo quick_time_select(7); ?>&end=<?php echo quick_time_select(8); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上月</a>-->
        <!--</div>-->
      <xblock>
          <span class="x-right" style="line-height:40px">合计保证金：<?php echo htmlentities(number_format($count['sum_money'],2,'.','')); ?>;手续费：<?php echo htmlentities(number_format($count['sum_fee'],2,'.','')); ?>;数量：<?php echo htmlentities($count['count']); ?> 条</span>
      </xblock>
      <table class="layui-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="td-manage">
                    <a title="查看"  onclick="x_admin_show('订单详情','/agent/Order/order_info?oid=<?php echo htmlentities($val['oid']); ?>')" href="javascript:;">
