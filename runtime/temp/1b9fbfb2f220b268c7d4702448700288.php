<?php /*a:1:{s:62:"/home/wwwroot/study/application/admin/view/index/personal.html";i:1562806576;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            ...
            $.post("/admin/Index/personal",data.field,function(res){
                if(res.status==0){
                    ...
                    layer.msg(res.msg,{icon: 1,time:1000},function(){
                        ...
                        parent.location.href="/admin/Login/logout";
