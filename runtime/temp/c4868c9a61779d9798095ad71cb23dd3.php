<?php /*a:1:{s:64:"/home/wwwroot/study/application/index/view/notice/help_info.html";i:1563599450;}*/ ?>
<!DOCTYPE html>
...
<div class="autobox">
    <div class="now">
        <i class="fa fa-home fa-lg move mr5"></i><a href="/index/Index/index" class="">首页</a> &gt;
        <a href="/index/Notice/help" class=""> 帮助中心 </a></div>
    <div class="assets_center clear po_re ">
        <div class="left-nav-bar" id="left-nav-bar">
            <div class="left-nav-slider">
                <dl class="nav-tab-list">
                    ...
                    <dt>
                        <a href="/index/Notice/help"><i class="fa fa-support mr10"></i>帮助中心</a>
                    </dt>
                    <dt class="nav-tab-hover hover1"></dt>

                    <dd class="active">
                        <a href="/index/Notice/index">
                            <i class="fa fa-tasks fa-lg fa-fw mr5"></i>官方公告
                            <i class="fa fa-angle-right fa-lg right mr10 mt17"></i>
                        </a>
                    </dd>
                    <dd>
                        <a href="/index/Notice/news">
                            <i class="fa fa-tasks fa-lg fa-fw mr5"></i>行业资讯
                            <i class="fa fa-angle-right fa-lg right mr10 mt17"></i>
                        </a>
                    </dd>
                    <dd>
                        <a href="/index/Notice/help">
                            <i class="fa fa-tasks fa-lg fa-fw mr5"></i>帮助中心
                            <i class="fa fa-angle-right fa-lg right mr10 mt17"></i>
                        </a>
                    </dd>
                    <dd>
                        <a href="/index/Notice/download">
                            <i class="fa fa-tasks fa-lg fa-fw mr5"></i>下载中心
                            <i class="fa fa-angle-right fa-lg right mr10 mt17"></i>
                        </a>
                    </dd>
                    <dd>
                        <a href="/index/Notice/about_us">
                            <i class="fa fa-tasks fa-lg fa-fw mr5"></i>关于我们
                            <i class="fa fa-angle-right fa-lg right mr10 mt17"></i>
                        </a>
                    </dd>
                </dl>
        ...
        <div class="assets_content w900 right bg_w mh1500">
            <div class="assets_content w900 right bg_w mh1500">
                <h1 class="h1news"><?php echo htmlentities($info['title']); ?></h1>
                <div class="new_list">
                    <div class="rightcontent">
                        <div class="articletime mt20 mb20">
                            <span>发布时间：<?php echo htmlentities($info['add_time']); ?></span>
                        </div>
