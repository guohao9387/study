<?php /*a:1:{s:65:"/home/wwwroot/study/application/admin/view/admin/notice_list.html";i:1562835044;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
            ...
            <input type="text" name="title"  placeholder="公告标题" autocomplete="off" class="layui-input" value="<?php echo input('get.title'); ?>">
    ...
    <xblock>
        ...
        <span class="x-right" style="line-height:40px">公告数量：<?php echo htmlentities($count); ?> 条</span>
    </xblock>
    <table class="layui-table">
        ...
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td><?php echo htmlentities(str_notice_type($vo['type'])); ?></td>
                ...
                <td class="td-manage">
                    <a title="编辑"  onclick="x_admin_show('编辑','/admin/Admin/notice_edit?id=<?php echo htmlentities($vo['id']); ?>')" href="javascript:;">
