<?php /*a:1:{s:72:"/home/wwwroot/study/application/admin/view/coin/apply_coin_give_log.html";i:1562751629;}*/ ?>
<!DOCTYPE html>
<html>
      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          ...
          <input class="layui-input" placeholder="截止日" name="end" id="end" value="<?php echo input('get.end'); ?>" autocomplete="off">
            ...
            <a href="<?php echo url('admin/Api/excel_apply_coin_give_log',input('get.')); ?>"  class="layui-btn" style="background-color: #337AB7">导出</a>

        </form>
      </div>
        <div class="layui-row">
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(1); ?>&end=<?php echo quick_time_select(2); ?>" class="layui-btn layui-btn-sm layui-btn-normal">昨天</a>
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(2); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">今天</a>
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(3); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本周</a>
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(4); ?>&end=<?php echo quick_time_select(5); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上周</a>
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(6); ?>&end=" class="layui-btn layui-btn-sm layui-btn-normal">本月</a>
            <a href="<?php echo url('admin/Coin/apply_coin_give_log',input('get.')); ?>&start=<?php echo quick_time_select(7); ?>&end=<?php echo quick_time_select(8); ?>" class="layui-btn layui-btn-sm layui-btn-normal">上月</a>
        </div>
      <xblock>
          <span class="x-right" style="line-height:40px">合计数量：<?php echo htmlentities($count['number']); ?> 条</span>
      </xblock>
      <table class="layui-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlentities($val['give_username']); ?></td>
